...
class _InsertCaseState extends State<InsertCase> {
  ...
  final TextEditingController motherNameController =
      TextEditingController(); // New controller for mother's name
  ...
  final TextEditingController chestSearchController =
      TextEditingController(); // Search controller for chests
  final TextEditingController subSearchController =
      TextEditingController(); // Search controller for subs
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                ...
                buildTextField('اسم الأم', 'أدخل اسم الأم',
                    motherNameController), // New mother's name field
                    ...
                    child: InputDecorator(
                      ...
                      child: Text(
                        _selectedBirthDate == null
                            ...
                            : '${_selectedBirthDate!.day}/${_selectedBirthDate!.month}/${_selectedBirthDate!.year} (العمر: ${AgeCalculator.calculateAge(_selectedBirthDate!.toIso8601String(), 0)})',
                        style: TextStyle(
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: isLoading
                          ? null
                          : submitForm, // Disable button while loading
