        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () => printItinerariesData(context, itineraries),
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text(
                              'التاريخ: ${itinerary['date'] != null ? DateFormat('yyyy-MM-dd').format(DateTime.parse(itinerary['date'])) : 'غير متوفر'}'),
                          Text(
...
buffer.writeln('<body>');
    ...
    if (itinerariesList.isEmpty) {
      buffer.writeln('<tr><td colspan="6">لا توجد بيانات للطباعة</td></tr>');
    } else {
      for (var data in itinerariesList) {
        buffer.writeln(
