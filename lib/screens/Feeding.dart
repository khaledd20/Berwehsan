...
class _FeedingPageState extends State<FeedingPage> {
  ...
  final List<Map<String, dynamic>> _selectedCases = [];
  ...
  void _printFeedingCases(String formattedDate) async {
    ...
    buffer.writeln(PrintStyle.getHeader('سجل إطعام اليوم ($formattedDate)'));
    buffer.writeln(
              ...
              onPressed: () {
                setState(() {
                  _selectedCases.add({
                    ...
                    'family_count':
                        int.tryParse(familyCountController.text.trim()) ?? 0,
                    'number': null,
                  });
                });
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return CheckboxListTile(
                          title: Text(
                              "اسم الحالة: ${caseData['name'] ?? 'غير معروف'}"),
                          subtitle: Text(
