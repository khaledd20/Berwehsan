...
class AddItemPage extends StatelessWidget {
  ...
  void addItem(BuildContext context) async {
    try {
      ...
      newItem['id'] =
          DateTime.now().millisecondsSinceEpoch % 1000; // Example ID generation
        ...
        body: Padding(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment
                .start, // Align labels and fields from right to left
            children: [
              TextField(
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  alignment:
                      Alignment.center, // Align button content to the right
                ),
